...
import domain.RandomCypherAdapter;
...
public class Main extends Application implements EventHandler<ActionEvent> {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        methode.getItems().add("RandomCypher");
    ...
    private String codeer(ChoiceBox<String> methode, String zin) {
        ...
        RandomCypherAdapter randomCypherAdapter = new RandomCypherAdapter();

        if (methode.getValue().equals("Caesar")) {
            output = caesar.codeer(zin);
        } else if (methode.getValue().equals("Mirror")) {
            output = mirror.codeer(zin);
        } else if (methode.getValue().equals("RandomCypher")){
            output = randomCypherAdapter.codeer(zin);
        }
        return output;
    }
    ...
    private String decodeer(ChoiceBox<String> methode, String zin){
        ...
        if(methode.getValue().equals("Caesar")){
            ...
            output = randomCypherAdapter.decodeer(zin);
        }
        return output;
    }
